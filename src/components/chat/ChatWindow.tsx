      ...
      <div className="px-6 py-4 border-t border-gray-200 bg-white">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            placeholder="Message..."
            className="flex-1 px-4 py-2.5 bg-gray-100 border border-gray-200 rounded-full text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white transition-all"
          />
          ...
          >
            <Send size={20} className={inputMessage.trim() ? 'text-blue-600' : 'text-gray-400'} />
          </button>
        </div>
      </div>
    </div>
